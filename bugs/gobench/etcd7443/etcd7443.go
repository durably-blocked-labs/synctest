// etcd#7443 — Concurrent Close Race (multiple goroutines)
// https://github.com/coreos/etcd/pull/7443
//
// close(b.notifyCh) races with for range b.notifyCh and b.notifyCh <- sends.
// Can cause panic (close of closed channel) or deadlock.
package etcd7443
...
func DialContext(_ context.Context, opts ...DialOption) *ClientConn {
	cc := &ClientConn{
