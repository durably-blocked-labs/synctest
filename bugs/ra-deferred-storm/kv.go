...
// NetworkKVStore runs as a separate orchestrator bubble, making every
// Get/Put visible as a message the orchestrator can reorder.
...
// KVClient sends KV operations as orchestrator-visible messages.
...
func (c *KVClient) Get(key string) int {
	...
	return (<-c.transport.KVMailbox()).Value
}
